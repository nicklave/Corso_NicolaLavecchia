...
print(f"Varianza cumulata spiegata dalle prime 4 componenti: {var_totale * 100}")
...
X_train_pca2, X_test_pca2, _, _ = train_test_split(X_pca2, y, test_size=0.3, random_state=42)
model_pca2 = LogisticRegression(max_iter=10000)
model_pca2.fit(X_train_pca2, y_train)
y_pred_pca2 = model_pca.predict(X_test_pca2)
accuracy_pca2 = accuracy_score(y_test, y_pred_pca2)
print(f"Accuratezza con dati ridotti (PCA - 4 dimensioni): {accuracy_pca:.2f}")